...
func (_m *RepoDBModel) AddItem(_a0 model.User, _a1 string, _a2 model.Link) error {
...
// BunchSave provides a mock function with given fields: _a0
func (_m *RepoDBModel) BunchSave(_a0 []model.Link) ([]model.ShortLink, error) {
	ret := _m.Called(_a0)

	var r0 []model.ShortLink
	if rf, ok := ret.Get(0).(func([]model.Link) []model.ShortLink); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
...
func (_m *RepoDBModel) GetByUser(_a0 model.User) (model.Links, error) {
	ret := _m.Called(_a0)
...
func (_m *RepoDBModel) GetItem(_a0 model.User, _a1 string) (model.Link, error) {
	ret := _m.Called(_a0, _a1)
